...
![image](remote_assets/059c6fa4-674c-47ce-a08e-0714b21cb39e.png)

Command `ipconfig /all` (Show local IP configuration on current DEVICE)

![image](remote_assets/b43b1d98-b510-4d05-be96-f706a3d090d1.png)

![image](remote_assets/7f56b6f1-12c6-4096-9f73-28c9f8cfd570.png)

Command `nslookup` (Shows IP information for a given DNS entry)

![image](remote_assets/71e5cd97-528c-435f-86d3-29d6ad2808b6.png)

WIRESHARK CAPTURE of above  COMMANDS

![image](remote_assets/9d9cd65c-8a8b-45b3-8914-28a53013618f.png)

![image](remote_assets/469431b3-e981-47cf-994d-642f737e79a0.png)

Command `ipconfig /displaydns` (Displays DNS cache)

![image](remote_assets/da36bc07-d834-4c5e-b7ab-71da025b912f.png)

Command `ipconfig /flushdns` (Clears DNS cache)

![image](remote_assets/f8608c2f-840c-477d-9284-7060838f1f3e.png)

## Hosts Files

WINDOWS HOSTS location

![image](remote_assets/771b6bd4-abe4-41b7-afc2-3984ccc23407.png)

![image](remote_assets/ff56876a-3b80-482f-b73b-caa86e5d972f.png)
...
![image](remote_assets/f65a4118-ae59-4db5-8fc4-c83d39c3072d.png)

![image](remote_assets/59743697-6347-41de-9359-ca7ef327af01.png)

![image](remote_assets/8e9c34c4-1a53-4ce4-a268-8a6d801d45e9.png)

Command `show hosts`

![image](remote_assets/306aa507-1523-43e5-ac48-251e8a75b5f8.png)

Command `ip name-server` and `ip domain lookup`

![image](remote_assets/cf0deb90-f8be-4f11-9373-2b7ef4715baf.png)

---

### **Command Review**

![image](remote_assets/6c3e7873-04c4-407e-a851-cb74a9f78eb9.png)
